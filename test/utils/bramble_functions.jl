	...
	@testset "BrambleFunction Tests with Real CartesianProduct" begin
		@testset "Embed Non-Time-Dependent" begin
			@testset "1D Domain" begin
				...
				@test bf1_macro isa BrambleFunction{Float64,false,Float64,typeof(Ω1)}
			...
			@testset "2D Domain" begin
				...
				@test bf2_macro isa BrambleFunction{NTuple{2,Float64},false,Float64,typeof(Ω2)}
			...
			@testset "3D Domain (Float32)" begin
				...
				@test bf3_macro isa BrambleFunction{NTuple{3,Float32},false,Float32,typeof(Ω3)}
