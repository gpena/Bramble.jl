...
function solve_poisson_nl(poisson_nl::PoissonNLProblem, nPoints::NTuple{D, Int},
        unif::NTuple{D, Bool}) where {D}
    Ω = domain(poisson_nl)
    X = set(Ω)
...
function test_poisson_nl(poisson_nl_problem::PoissonNLProblem, nTests,
