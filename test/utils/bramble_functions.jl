using Test
using Bramble
using Bramble: BrambleFunction, interval, ×, cartesian_product, domain, embed_function, argstype, codomaintype, has_time
using StaticArrays
...
@testset "BrambleFunction Tests with Real CartesianProduct" begin
	...
	@testset "Embed Non-Time-Dependent" begin
		...
		@testset "Embed on Domain Struct" begin
			...
			@test bf_dom isa BrambleFunction{NTuple{2,Float64},false,Float64,typeof(dom)}
